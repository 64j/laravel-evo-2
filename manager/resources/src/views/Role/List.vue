<template>
  <div>
    ...
    <TitleView :title="title" :icon="icon" :message="$store.getters['Lang/get']('role_management_msg')"/>
...
export default {
  ...
  data () {
    return {
      ...
      columns: {
        ...
        description: {
          title: this.$store.getters['Lang/get']('description')
        },
        delete: {
  ...
  computed: {
    title () {
      return this.$store.getters['Lang/get']('role_management_title')
    }
  },
  created () {
    this.$emit('titleTab', {
