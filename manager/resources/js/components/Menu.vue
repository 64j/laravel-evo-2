    ...
    <div class="flex-auto">
      <ul class="nav h-full">
        ...
        <li class="parent" v-if="hasPermissions('exec_module')" @mouseenter="getSubMenu('Module@list', list.modules)">
          <a>{{ lang('modules') }}</a>
          <ul v-if="list.modules.length" class="bg-white text-gray-900">
...
<!--              </router-link>-->
        ...
        <li class="parent" v-if="hasPermissions(['settings', 'view_eventlog', 'logs', 'help'])">
          ...
          <ul class="bg-white text-gray-900">
            ...
            <li>
              <span class="justify-center text-gray-400">
                {{ $store.getters['Config/get']('settings_version') }}
              </span>
            </li>
          </ul>
        </li>
...
.menu li > a, .menu li > span { display: flex; align-items: center; padding: .85rem 1rem; height: 100%; text-decoration: none; cursor: pointer; user-select: none; }
...
.menu ul.nav > li > a:hover, .app-header.active .menu ul.nav > li > a.router-link-active {  }
.menu ul.nav > li > a.router-link-active {  }
.app-header.active .menu ul.nav > li.parent.hover > a { background-color: white; color: #222; }
.menu ul.nav > li > a { position: relative; z-index: 2; padding: 0 1.25rem; }
.menu ul.nav > li ul { display: none; position: absolute; z-index: 1; top: 100%; padding: 0 0 .25rem; min-width: 20rem; max-height: calc(100vh - 3rem); box-shadow: 0 .5rem 1rem rgba(0, 0, 0, .15); border-radius: 0 0 .35rem .35rem; }
.menu ul.nav > li > ul { left: 0; }
.menu .justify-end ul.nav > li > ul { left: auto; right: 0; }
...
.menu ul.nav > li > ul > li > a.router-link-active {  }
.menu ul.nav > li > ul li.hover > a { background-color: rgb(37 99 235 / 1); color: white }
...
<style>
.app-header.active + .app-body::before { content: ""; position: absolute; z-index: 999; left: 0; top: 0; right: 0; bottom: 0; opacity: .15; }
</style>
